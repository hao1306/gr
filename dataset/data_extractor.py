...
def extract_image_position():
    ...
    for i, sc in enumerate(scene):
        f_scene = open('dataset/nuscenes/image_scenes/'+sc['name']+'.csv', 'w')
        for s in sample:
            if s["scene_token"] == sc['token']:
                ...
                for index in index0[0]:
                    ...
                    f_scene.write(sample_data_new[index]['filename']+','+str(ego_pose[index1]['translation'][0])+','+str(ego_pose[index1]['translation'][1])+','+sample_data_new[index]['sample_token']+'\n')
        f_scene.close()
        print(i)
...
if __name__ == '__main__':
    ...
    filepaths = glob.glob('dataset/nuscenes/image_scenes/*.csv')
    for filepath in filepaths:
        ...
        if filename[:-4] in val:
            shutil.move(filepath, 'dataset/nuscenes/image_scenes/val')
        else:
            shutil.move(filepath, 'dataset/nuscenes/image_scenes/train')
